package com.example.imagedetectiontflite
...
class MainActivity : AppCompatActivity() {
        ...
        analyzerUseCase.analyzer =
            ImageAnalysis.Analyzer { image: ImageProxy, rotationDegrees: Int ->
                ...
                tfLiteClassifier
                    ...
                    .addOnSuccessListener { resultText -> OnClassifySuccessFul(resultText) }
    ...
    private fun OnClassifySuccessFul(resultText: String?) {
